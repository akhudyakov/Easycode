package HomeTaskInstituteOnList.additionalFunctional;
...
//               temp mark = 2
    ...
    public static void getWorstStudentInTheGroup(Group gr) {
        ...
        HashSet<Student> arrayStudentInGroup = gr.getArrayWithStudents();
        Iterator<Student> studentIterator = arrayStudentInGroup.iterator();
        while (studentIterator.hasNext()) {
            studentTemp = studentIterator.next();
            averageMark = getAverageMarkByStudent(studentTemp);

//            studentWithAverageMark[][0] = studentTemp.getNumberStudent();
